...
| https://github.com/LogNet/grpc-spring-boot-starter & https://github.com/yidongnan/grpc-spring-boot-starter & https://github.com/DanielLiu1123/grpc-starter & ⭐https://github.com/grpc-ecosystem/grpc-spring (hosted by grpc-ecosystem) ⭐
