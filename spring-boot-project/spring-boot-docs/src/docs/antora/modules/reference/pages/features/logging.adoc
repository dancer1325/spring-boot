...
* Spring Boot
    ...
    ** 👁️ BUT underlying log implementation is open 👁️
        *** _Example:_
        ...
        *** 👁️ if you use the starters -> Logback is used 👁️/ include
            **** appropriate Logback routing /
                ***** dependent libraries / use Java Util Logging, Commons Logging, Log4J, or SLF4J work ALL correctly
* if you use Java Util Logging API & you deploy your application | servlet container -> logging is NOT routed | your application's logs
