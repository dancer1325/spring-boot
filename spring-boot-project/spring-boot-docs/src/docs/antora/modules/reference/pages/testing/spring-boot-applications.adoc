...
* Spring Boot application
    ** == Spring `ApplicationContext`
        *** -> testing Spring Boot application == testing vanilla Spring context
    ** if you use `SpringApplication` -> features of Spring Boot (_Example:_ external properties, logging) are installed in the context by default
